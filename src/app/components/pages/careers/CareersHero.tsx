...
function Heading() {
  return (
    <div
      ...
      data-name="Heading"
    >
      <p className="font-['GT_Super_Ds_Trial:Rg',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#2d3648] text-[18px] md:text-[24px] text-center tracking-[-0.48px] w-full max-w-[386px]">
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="About Us">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center px-[20px] md:px-[180px] py-[60px] md:py-[90px] relative w-full">
          <Container />
          <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#53627e] text-[16px] md:text-[18px] text-center w-full max-w-[578px]">{`We believe great work comes from diverse collaboration. That's why we work closely with each other to ensure every project meets your goals and exceeds expectations`}</p>
        </div>
      </div>
    </div>
  );
