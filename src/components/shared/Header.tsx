...
const Header = () => {
  const { navbarState, setDrawerState, toggleSchedule } = useAppContext();
  ...
  return (
    <header
      ...
      className={`sticky content-stretch flex flex-col items-center  z-40
        ...
        ${navbarState === "transparent" ? "bg-transparent text-white" : "bg-white text-black"}`}
    >
      <div
      ...
      >
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between px-[64px] py-[30px] relative w-full">
            ...
            <Logo />
            <div
              className="basis-0 content-stretch flex grow items-center justify-end min-h-px min-w-px relative shrink-0 cursor-pointer hover:opacity-70 transition-opacity"
              data-name="Button"
