...
export const PlaceholderImage = () => {
  return (
    <div
      className="absolute size-[80px] left-1/2 top-[calc(50%)] translate-x-[-50%] translate-y-[-50%]"
      data-name="image-01"
    >
      <svg
...
export const PlaceholderVideo = () => {
  return (
    <div
      className="absolute  size-[80px] left-1/2 top-[calc(50%-44.5px)] translate-x-[-50%] translate-y-[-50%]"
      data-name="film"
    >
      <svg
        className="block size-full"
