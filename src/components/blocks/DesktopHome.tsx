...
function Button() {
  return (
    <div className="h-[24px] relative shrink-0 w-[83px]" data-name="Button">
      <p className="absolute font-['EB_Garamond:Regular',sans-serif] font-normal leading-[normal] left-[41.5px] text-[14px] text-center text-nowrap text-white top-0 tracking-[3.36px] translate-x-[-50%]">
        ENQUIRE
      </p>
    </div>
  );
...
function WfHeader() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-center justify-center left-1/2 overflow-clip top-[-90px] translate-x-[-50%] w-[1440px]"
      data-name="WF Header"
    >
      <Padding />
    </div>
...
function Hero() {
  return (
    <div
      className="absolute h-[935px] left-0 overflow-clip top-[90px] w-[1440px]"
      data-name="Hero"
    >
      <Film />
      <WfHeader />
...
function Navbar() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-center justify-center left-1/2 overflow-clip top-0 translate-x-[-50%] w-[1440px]"
      data-name="Navbar"
    >
      <Padding1 />
    </div>
...
function Heading() {
  return (
    <div
      ...
      data-name="Heading"
    >
      <p className="font-['GT_Super_Ds_Trial:Rg',sans-serif] not-italic relative shrink-0 text-[#2d3648] text-[22px] tracking-[-0.44px] w-[371px]">
        <span>{`We meet you `}</span>
        <span className="font-['GT_Super_Ds_Trial:Rg_It',sans-serif]">{`where you are `}</span>
        <span>{`and build the systems that `}</span>
        <span className="font-['GT_Super_Ds_Trial:Rg_It',sans-serif]">
          move you forward.
        </span>
      </p>
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal min-w-full relative shrink-0 text-[#53627e] text-[16px] w-[min-content]">
...
function Image5() {
  return (
    <div
      className="absolute left-[210px] size-[80px] top-[314px]"
      data-name="image-01"
    >
      <svg
        className="block size-full"
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <p className="font-['GT_Super_Txt_Trial:Bk_It',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#53627e] text-[16px] text-nowrap">
        view more
      </p>
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['EB_Garamond:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#53627e] text-[16px] text-nowrap tracking-[6.4px]">
        SELECTED WORK
      </p>
      <Frame4 />
    </div>
...
function Row() {
  return (
    <div
      className="content-stretch flex gap-[80px] h-[708px] items-start relative shrink-0 w-full"
      data-name="Row"
    >
      <Frame1 />
      <Frame2 />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="About Us">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[180px] py-[90px] relative w-full">
          <Container />
        </div>
      </div>
    </div>
...
function Heading1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-[480px]"
      data-name="Heading"
    >
      <p className="font-['GT_Super_Ds_Trial:Rg',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#2d3648] text-[22px] text-center tracking-[-0.44px] w-[371px]">
        <span>
          We’re human,
          <br aria-hidden="true" />
          {`We don’t `}
      ...
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#53627e] text-[16px] text-center w-[min-content]">
...
function Image3() {
  return (
    <div
      className="absolute left-1/2 size-[80px] top-[314px] translate-x-[-50%]"
      data-name="image-01"
    >
      <svg
        className="block size-full"
    ...
    <div className="bg-[#394e79] relative shrink-0 w-full" data-name="Footer">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[56px] items-center px-[180px] py-[49px] relative w-full">
          <p className="font-['GT_Super_Ds_Trial:Rg',sans-serif] leading-[normal] not-italic relative shrink-0 text-[26px] text-center text-white tracking-[5.2px] uppercase w-full">
            Re:Initiative
          </p>
          <LinksCopyright />
        </div>
