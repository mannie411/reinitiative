...
function Content() {
  return (
    <div
      className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-[607px]"
      data-name="Content"
    >
      <Frame />
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#53627e] text-[16px] w-[min-content]">
...
function Content1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 text-[16px] w-[219px]"
      data-name="Content"
    >
...
function Frame7() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-[1080px]">
      <Content />
      <Content1 />
    </div>
  );
...
function Content2() {
  return (
    <div
      className="content-stretch flex flex-col items-start relative shrink-0 w-[504px]"
      data-name="Content"
    >
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#53627e] text-[16px] text-center w-[504px]">
...
function Heading() {
  return (
    <div
      ...
      data-name="Heading"
    >
      <div className="font-['GT_Super_Ds_Trial:Rg',sans-serif] leading-[0] not-italic relative shrink-0 text-[#2d3648] text-[22px] text-center tracking-[-0.44px] w-[371px]">
        <p className="leading-[normal] mb-0">{`Great brands aren't born. `}</p>
        <p className="leading-[normal]">
          <span>{`They're `}</span>
          <span className="font-['GT_Super_Ds_Trial:Rg_It',sans-serif] not-italic">
            built.
          </span>
        </p>
      </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="About Us">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[72px] items-center px-[180px] py-[90px] relative w-full">
          <Frame7 />
          <Row />
          <Row />
          <Frame8 />
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative self-stretch shrink-0">
      <Image2 />
      <Frame6 />
    </div>
  );
