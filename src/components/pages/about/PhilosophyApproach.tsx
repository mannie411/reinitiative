...
function Content() {
  return (
    <div
      ...
      data-name="Content"
    >
      <p className="font-avenir-lt leading-[normal] not-italic relative shrink-0 text-[#53627e] text-[12px] tracking-[2.4px] uppercase w-full">
        our Philosophy
      </p>
      <div className="font-eb-garamond font-normal leading-[normal] relative shrink-0 text-[#2d3648] text-[16px] w-full">
