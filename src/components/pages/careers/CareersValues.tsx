...
export function CareersValues() {
  return (
    <section className="relative">
        ...
        border-solid inset-0 pointer-events-none "
          ...
          >
            <div className="basis-0 flex flex-row grow items-center self-stretch  w-full">
              <Column>
                <div
                  className="content-stretch flex flex-col gap-[16px] items-start text-center md:text-start text-[#53627e] w-full max-w-[380px]"
                  data-name="Content"
                >
                  <p
                  ...
                  <div className="font-eb-garamond font-normal leading-[normal] relative  text-[16px] w-full">
                    ...
                    <p className="mb-0">
                      <span className="text-[#53627e]">
                        A team obsessed with turning scattered potential into
                        strategic systems. We work with ambitious brands at
      ...
      relative  text-[#53627e] w-full max-w-[380px] text-centert md:text-start"
                  data-name="Content"
                >
                  <p
                    className="font-avenir-lt leading-[normal] not-italic relative 
       text-[12px] tracking-[2.4px] uppercase w-full text-center md:text-start"
                  >
                    What We Value
                  </p>
                  <div className="font-eb-garamond font-normal leading-[normal] relative  text-[16px] w-full">
                    ...
                    <p className="mb-0 text-[#53627e]">
                      Integration over isolation Every discipline connects.
                      Every decision compounds.
                    </p>
                    <p className="mb-0">&nbsp;</p>
                    <p className="mb-0 text-[#53627e]">
                      Partnership over ego The best work comes from
                      collaboration, not competition. Growth over comfort
                    </p>
                    <p className="mb-0">&nbsp;</p>
                    <p className="text-[#53627e]">
                      We challenge each other. We support each other. We all get
                      better.
                    </p>
                  </div>
                </div>
       ...
       text-[#53627e] w-full max-w-[380px] text-center md:text-start "
                  data-name="Content"
                >
                  <p
                    className="font-avenir-lt leading-[normal] not-italic relative  
      text-[12px] tracking-[2.4px] uppercase w-full"
                  ...
                  <div className="font-eb-garamond font-normal leading-[normal] relative  text-[16px] w-full">
                    <p className="mb-0">
                      Curious minds. Clear communicators. People who ask "why"
                      before "how."
                    </p>
                    <p className="mb-0">
                      You don't need to know everything. But you need to want to
                      learn everything.
                    </p>
                    <p className="mb-0">&nbsp;</p>
                    <p>
                      We hire for thinking, not just skill. For potential, not
                      just portfolio.
                    </p>
                  </div>
                </div>
